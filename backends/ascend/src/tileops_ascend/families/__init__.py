...
Regression guard: ``tileops-ascend/tests/test_registration_reachable.py`` asserts
that a plain ``import tileops_ascend`` registers every op that importing the family
