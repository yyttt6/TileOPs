...
import tileops_ascend  # noqa: F401 - registers the Ascend builders
...
def run_op(op_name, out_dir: Path, report_dir: Path):
    ...
    result = {
        ...
        "correctness": {
            "passed": passed,
            "cmd": "python -u tileops-ascend/tests/t031_coverage.py --out tileops-ascend-harness/coverage --report-out docs/reports/R031-data/coverage",
            "per_case": cases,
        },
        "perf": {
