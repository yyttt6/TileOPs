...
from tileops_ascend.families.gemm import build_bmm
from tileops_ascend.kernels.common import MAX_BLOCK_COUNT, launch_block_count
...
def main() -> None:
    ...
    destination = Path(__file__).resolve().parents[2] / "tileops-ascend-harness/coverage/BmmFwdOp.json"
