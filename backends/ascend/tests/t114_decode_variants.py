...
from tileops_ascend.kernels.attention_decode import (  # noqa: E402
...
def _result(op_name, correctness_cases, perf_cases):
    ...
    return {
        ...
        "correctness": {
            ...
            "cmd": "cd /home/dyq/workspace && export ASCEND_RT_VISIBLE_DEVICES=3 && python tileops-ascend/tests/t114_decode_variants.py --out tileops-ascend-harness/coverage --evidence docs/reports/R114-data/coverage",
