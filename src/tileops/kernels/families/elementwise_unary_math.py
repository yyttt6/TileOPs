...
from ..elementwise_unary import FLOAT_DTYPES, INT_DTYPES, build_unary_kernel
...
build_acos = _register("AcosFwdOp", "acos", _FLOAT)
build_asin = _register("AsinFwdOp", "asin", _FLOAT)
build_atan = _register("AtanFwdOp", "atan", _FLOAT)
...
build_log2 = _register("Log2FwdOp", "log2", _FLOAT)
...
build_tan = _register("TanFwdOp", "tan", _FLOAT)
