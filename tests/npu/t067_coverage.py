...
import tileops.kernels.families.two_pass  # noqa: F401
from tileops.kernels.families.two_pass import _compile_norm
...
def run(name: str, out_dir: Path, report_dir: Path) -> None:
    ...
    result = {
        ...
        "correctness": {"passed": passed, "cmd": f"python -u TileOPs/tests/npu/t067_coverage.py {name} --out tileops-ascend-harness/coverage --report-out docs/reports/R067-data/coverage", "per_case": cases},
